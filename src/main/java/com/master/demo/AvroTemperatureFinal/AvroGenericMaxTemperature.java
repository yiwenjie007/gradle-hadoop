package com.master.demo.AvroTemperatureFinal;
...
public class AvroGenericMaxTemperature extends Configured implements Tool {
    ...
    static {
        try {
            SCHEMA = new Schema.Parser().parse(new FileInputStream(new File("src/main/resources/avro/AvroTemperature.avsc")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
//    );
    ...
    public static void main(String[] args) throws Exception {
        Path input = new Path("src/main/resources/avro/input");
        Path output = new Path("src/main/resources/avro/output");
        int exitCode = ToolRunner.run(new AvroGenericMaxTemperature(), new String[]{input.toString(), output.toString()});
